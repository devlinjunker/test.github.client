...
var InlineObject58 = /*#__PURE__*/function () {
   ...
   * @param content {module:model/InlineObject58.ContentEnum} The [reaction type](https://developer.github.com/v3/reactions/#reaction-types) to add to the commit comment.
   */
  function InlineObject58(content) {
    _classCallCheck(this, InlineObject58);

    InlineObject58.initialize(this, content);
  }
  /**
 ...
 * @member {module:model/InlineObject58.ContentEnum} content
 */


InlineObject58.prototype['content'] = undefined;
/**
