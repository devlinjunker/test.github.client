...
var _EventPayload = _interopRequireDefault(require("./EventPayload"));
...
var Event = /*#__PURE__*/function () {
   ...
   * @param type {String} 
   */
  function Event(actor, createdAt, id, payload, _public, repo, type) {
  ...
  _createClass(Event, null, [{
    key: "initialize",
    value: function initialize(obj, actor, createdAt, id, payload, _public, repo, type) {
      obj['actor'] = actor;
    ...
    value: function constructFromObject(data, obj) {
      if (data) {
        ...
        if (data.hasOwnProperty('org')) {
          obj['org'] = _Actor["default"].constructFromObject(data['org']);
        }

        if (data.hasOwnProperty('payload')) {
          obj['payload'] = _EventPayload["default"].constructFromObject(data['payload']);
        }
