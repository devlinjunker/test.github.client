...
var CommitComment = /*#__PURE__*/function () {
   ...
   */
  function CommitComment(authorAssociation, body, commitId, createdAt, htmlUrl, id, line, nodeId, path, position, updatedAt, url, user) {
  ...
  _createClass(CommitComment, null, [{
    key: "initialize",
    value: function initialize(obj, authorAssociation, body, commitId, createdAt, htmlUrl, id, line, nodeId, path, position, updatedAt, url, user) {
