...
var _ReposOwnerRepoHooksConfig = _interopRequireDefault(require("./ReposOwnerRepoHooksConfig"));
...
var InlineObject72 = /*#__PURE__*/function () {
   ...
   */
  function InlineObject72(config) {
  ...
  _createClass(InlineObject72, null, [{
    key: "initialize",
    value: function initialize(obj, config) {
      obj['config'] = config;
    }
    /**
    ...
    value: function constructFromObject(data, obj) {
      if (data) {
        ...
        if (data.hasOwnProperty('config')) {
          obj['config'] = _ReposOwnerRepoHooksConfig["default"].constructFromObject(data['config']);
        }
