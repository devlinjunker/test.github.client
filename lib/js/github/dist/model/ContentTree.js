...
var _ContentTreeEntries = _interopRequireDefault(require("./ContentTreeEntries"));
 ...
 * @version 0.0.5
 */
var ContentTree = /*#__PURE__*/function () {
  /**
   ...
   * @param url {String} 
   */
  function ContentTree(links, downloadUrl, gitUrl, htmlUrl, name, path, sha, size, type, url) {
    ...
    value: function constructFromObject(data, obj) {
      if (data) {
        ...
        if (data.hasOwnProperty('entries')) {
          obj['entries'] = _ApiClient["default"].convertToType(data['entries'], [_ContentTreeEntries["default"]]);
        }
