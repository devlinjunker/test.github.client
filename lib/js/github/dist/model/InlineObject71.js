...
var _ReposOwnerRepoGitTreesTree = _interopRequireDefault(require("./ReposOwnerRepoGitTreesTree"));
...
var InlineObject71 = /*#__PURE__*/function () {
  ...
  _createClass(InlineObject71, null, [{
    key: "initialize",
    value: function initialize(obj, tree) {
      obj['tree'] = tree;
    }
    /**
    ...
    value: function constructFromObject(data, obj) {
      if (data) {
        ...
        if (data.hasOwnProperty('tree')) {
          obj['tree'] = _ApiClient["default"].convertToType(data['tree'], [_ReposOwnerRepoGitTreesTree["default"]]);
        }
      }
