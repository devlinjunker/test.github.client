...
var _RepoSearchResultItem = _interopRequireDefault(require("./RepoSearchResultItem"));
    ...
    value: function constructFromObject(data, obj) {
      if (data) {
        ...
        if (data.hasOwnProperty('items')) {
          obj['items'] = _ApiClient["default"].convertToType(data['items'], [_RepoSearchResultItem["default"]]);
        }
