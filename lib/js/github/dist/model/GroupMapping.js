...
var _GroupMappingGroups = _interopRequireDefault(require("./GroupMappingGroups"));
 ...
 * @version 0.0.5
 */
var GroupMapping = /*#__PURE__*/function () {
  /**
  ...
  _createClass(GroupMapping, null, [{
    key: "initialize",
    ...
    value: function constructFromObject(data, obj) {
      if (data) {
        ...
        if (data.hasOwnProperty('groups')) {
          obj['groups'] = _ApiClient["default"].convertToType(data['groups'], [_GroupMappingGroups["default"]]);
        }
