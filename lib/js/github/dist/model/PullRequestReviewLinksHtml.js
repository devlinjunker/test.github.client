 ...
 * @version 0.0.5
 */
var PullRequestReviewLinksHtml = /*#__PURE__*/function () {
  /**
   * Constructs a new <code>PullRequestReviewLinksHtml</code>.
   * @alias module:model/PullRequestReviewLinksHtml
   * @param href {String} 
   */
  function PullRequestReviewLinksHtml(href) {
    _classCallCheck(this, PullRequestReviewLinksHtml);
  ...
  _createClass(PullRequestReviewLinksHtml, null, [{
    key: "initialize",
...
var _default = PullRequestReviewLinksHtml;
