 ...
 * @version 0.0.5
 */
var CommitSearchResultItemCommitAuthor = /*#__PURE__*/function () {
  /**
   ...
   * @param name {String} 
   */
  function CommitSearchResultItemCommitAuthor(_date, email, name) {
    _classCallCheck(this, CommitSearchResultItemCommitAuthor);
  ...
  _createClass(CommitSearchResultItemCommitAuthor, null, [{
    key: "initialize",
...
var _default = CommitSearchResultItemCommitAuthor;
