 ...
 * @version 0.0.5
 */
var LinkWithType = /*#__PURE__*/function () {
  /**
   ...
   * @param type {String} 
   */
  function LinkWithType(href, type) {
    _classCallCheck(this, LinkWithType);
  ...
  _createClass(LinkWithType, null, [{
    key: "initialize",
    value: function initialize(obj, href, type) {
      obj['href'] = href;
      obj['type'] = type;
    }
    /**
