...
var _OrgsOrgTeamsTeamSlugTeamSyncGroupMappingsGroups = _interopRequireDefault(require("./OrgsOrgTeamsTeamSlugTeamSyncGroupMappingsGroups"));
    ...
    value: function constructFromObject(data, obj) {
      if (data) {
        ...
        if (data.hasOwnProperty('groups')) {
          obj['groups'] = _ApiClient["default"].convertToType(data['groups'], [_OrgsOrgTeamsTeamSlugTeamSyncGroupMappingsGroups["default"]]);
        }
      }
