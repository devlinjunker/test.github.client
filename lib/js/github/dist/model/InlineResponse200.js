...
var InlineResponse200 = /*#__PURE__*/function () {
  ...
  _createClass(InlineResponse200, null, [{
    key: "initialize",
    value: function initialize(obj, authorizationsUrl, codeSearchUrl, commitSearchUrl, currentUserAuthorizationsHtmlUrl, currentUserRepositoriesUrl, currentUserUrl, emailsUrl, emojisUrl, eventsUrl, feedsUrl, followersUrl, followingUrl, gistsUrl, hubUrl, issueSearchUrl, issuesUrl, keysUrl, labelSearchUrl, notificationsUrl, organizationRepositoriesUrl, organizationTeamsUrl, organizationUrl, publicGistsUrl, rateLimitUrl, repositorySearchUrl, repositoryUrl, starredGistsUrl, starredUrl, userOrganizationsUrl, userRepositoriesUrl, userSearchUrl, userUrl) {
    ...
    value: function constructFromObject(data, obj) {
      if (data) {
        ...
        if (data.hasOwnProperty('authorizations_url')) {
          obj['authorizations_url'] = _ApiClient["default"].convertToType(data['authorizations_url'], 'String');
        }

        if (data.hasOwnProperty('code_search_url')) {
          obj['code_search_url'] = _ApiClient["default"].convertToType(data['code_search_url'], 'String');
        }

        if (data.hasOwnProperty('commit_search_url')) {
          obj['commit_search_url'] = _ApiClient["default"].convertToType(data['commit_search_url'], 'String');
        }

        if (data.hasOwnProperty('current_user_authorizations_html_url')) {
          obj['current_user_authorizations_html_url'] = _ApiClient["default"].convertToType(data['current_user_authorizations_html_url'], 'String');
        }

        if (data.hasOwnProperty('current_user_repositories_url')) {
          obj['current_user_repositories_url'] = _ApiClient["default"].convertToType(data['current_user_repositories_url'], 'String');
        }
        ...
        if (data.hasOwnProperty('emails_url')) {
          obj['emails_url'] = _ApiClient["default"].convertToType(data['emails_url'], 'String');
        }

        if (data.hasOwnProperty('emojis_url')) {
          obj['emojis_url'] = _ApiClient["default"].convertToType(data['emojis_url'], 'String');
        }
        ...
        if (data.hasOwnProperty('feeds_url')) {
          obj['feeds_url'] = _ApiClient["default"].convertToType(data['feeds_url'], 'String');
        }
        ...
        if (data.hasOwnProperty('hub_url')) {
          obj['hub_url'] = _ApiClient["default"].convertToType(data['hub_url'], 'String');
        }

        if (data.hasOwnProperty('issue_search_url')) {
          obj['issue_search_url'] = _ApiClient["default"].convertToType(data['issue_search_url'], 'String');
        }
        ...
        if (data.hasOwnProperty('label_search_url')) {
          obj['label_search_url'] = _ApiClient["default"].convertToType(data['label_search_url'], 'String');
        }
        ...
        if (data.hasOwnProperty('organization_repositories_url')) {
          obj['organization_repositories_url'] = _ApiClient["default"].convertToType(data['organization_repositories_url'], 'String');
        }

        if (data.hasOwnProperty('organization_teams_url')) {
          obj['organization_teams_url'] = _ApiClient["default"].convertToType(data['organization_teams_url'], 'String');
        }
        ...
        if (data.hasOwnProperty('public_gists_url')) {
          obj['public_gists_url'] = _ApiClient["default"].convertToType(data['public_gists_url'], 'String');
        }

        if (data.hasOwnProperty('rate_limit_url')) {
          obj['rate_limit_url'] = _ApiClient["default"].convertToType(data['rate_limit_url'], 'String');
        }

        if (data.hasOwnProperty('repository_search_url')) {
          obj['repository_search_url'] = _ApiClient["default"].convertToType(data['repository_search_url'], 'String');
        }
        ...
        if (data.hasOwnProperty('starred_gists_url')) {
          obj['starred_gists_url'] = _ApiClient["default"].convertToType(data['starred_gists_url'], 'String');
        }
        ...
        if (data.hasOwnProperty('topic_search_url')) {
          obj['topic_search_url'] = _ApiClient["default"].convertToType(data['topic_search_url'], 'String');
        }

        if (data.hasOwnProperty('user_organizations_url')) {
          obj['user_organizations_url'] = _ApiClient["default"].convertToType(data['user_organizations_url'], 'String');
        }

        if (data.hasOwnProperty('user_repositories_url')) {
          obj['user_repositories_url'] = _ApiClient["default"].convertToType(data['user_repositories_url'], 'String');
        }

        if (data.hasOwnProperty('user_search_url')) {
          obj['user_search_url'] = _ApiClient["default"].convertToType(data['user_search_url'], 'String');
        }
