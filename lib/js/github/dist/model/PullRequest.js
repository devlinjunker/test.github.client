...
var _PullRequestHead = _interopRequireDefault(require("./PullRequestHead"));
...
var PullRequest = /*#__PURE__*/function () {
  ...
  _createClass(PullRequest, null, [{
    key: "initialize",
    value: function initialize(obj, links, additions, assignee, authorAssociation, base, body, changedFiles, closedAt, comments, commentsUrl, commits, commitsUrl, createdAt, deletions, diffUrl, head, htmlUrl, id, issueUrl, labels, locked, maintainerCanModify, mergeCommitSha, mergeable, mergeableState, merged, mergedAt, mergedBy, milestone, nodeId, _number, patchUrl, reviewCommentUrl, reviewComments, reviewCommentsUrl, state, statusesUrl, title, updatedAt, url, user) {
      obj['_links'] = links;
    ...
    value: function constructFromObject(data, obj) {
      if (data) {
        ...
        if (data.hasOwnProperty('head')) {
          obj['head'] = _PullRequestHead["default"].constructFromObject(data['head']);
        }
        ...
        if (data.hasOwnProperty('mergeable_state')) {
          obj['mergeable_state'] = _ApiClient["default"].convertToType(data['mergeable_state'], 'String');
        }
        ...
        if (data.hasOwnProperty('merged_by')) {
          obj['merged_by'] = _ApiClient["default"].convertToType(data['merged_by'], _SimpleUser["default"]);
        }
        ...
        if (data.hasOwnProperty('rebaseable')) {
          obj['rebaseable'] = _ApiClient["default"].convertToType(data['rebaseable'], 'Boolean');
        }
        ...
        if (data.hasOwnProperty('review_comments')) {
          obj['review_comments'] = _ApiClient["default"].convertToType(data['review_comments'], 'Number');
        }
