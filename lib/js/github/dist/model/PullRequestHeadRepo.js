...
var _PullRequestHeadRepoLicense = _interopRequireDefault(require("./PullRequestHeadRepoLicense"));
 ...
 * @version 0.0.5
 */
var PullRequestHeadRepo = /*#__PURE__*/function () {
  /**
  ...
  _createClass(PullRequestHeadRepo, null, [{
    key: "initialize",
    ...
    value: function constructFromObject(data, obj) {
      if (data) {
        ...
        if (data.hasOwnProperty('license')) {
          obj['license'] = _PullRequestHeadRepoLicense["default"].constructFromObject(data['license']);
        }
        ...
        if (data.hasOwnProperty('owner')) {
          obj['owner'] = _PullRequestBaseRepoOwner["default"].constructFromObject(data['owner']);
        }
...
var _default = PullRequestHeadRepo;
