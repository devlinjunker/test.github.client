...
var _PullRequestBaseRepo = _interopRequireDefault(require("./PullRequestBaseRepo"));
...
var PullRequestBase = /*#__PURE__*/function () {
   ...
   */
  function PullRequestBase(label, ref, repo, sha, user) {
    ...
    value: function constructFromObject(data, obj) {
      if (data) {
        ...
        if (data.hasOwnProperty('repo')) {
          obj['repo'] = _PullRequestBaseRepo["default"].constructFromObject(data['repo']);
        }
