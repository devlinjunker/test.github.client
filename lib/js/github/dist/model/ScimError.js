 ...
 * @version 0.0.5
 */
var ScimError = /*#__PURE__*/function () {
  /**
   ...
   */
  function ScimError() {
    _classCallCheck(this, ScimError);
    ...
    value: function constructFromObject(data, obj) {
      if (data) {
        ...
        if (data.hasOwnProperty('scimType')) {
          obj['scimType'] = _ApiClient["default"].convertToType(data['scimType'], 'String');
        }
