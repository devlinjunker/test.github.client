 ...
 * @version 0.0.5
 */
var BranchWithProtectionLinks = /*#__PURE__*/function () {
  /**
   ...
   * @param self {String} 
   */
  function BranchWithProtectionLinks(html, self) {
    _classCallCheck(this, BranchWithProtectionLinks);
  ...
  _createClass(BranchWithProtectionLinks, null, [{
    key: "initialize",
    value: function initialize(obj, html, self) {
      obj['html'] = html;
      obj['self'] = self;
    }
    /**
...
var _default = BranchWithProtectionLinks;
