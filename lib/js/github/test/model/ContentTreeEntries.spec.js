...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new GitHubV3RestApi.ContentTreeEntries();
  });
  ...
  describe('ContentTreeEntries', function() {
    it('should create an instance of ContentTreeEntries', function() {
      // uncomment below and update the code to test ContentTreeEntries
      //var instane = new GitHubV3RestApi.ContentTreeEntries();
      //expect(instance).to.be.a(GitHubV3RestApi.ContentTreeEntries);
    });
