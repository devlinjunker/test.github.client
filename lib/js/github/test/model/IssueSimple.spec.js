...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new GitHubV3RestApi.IssueSimple();
  });
  ...
  describe('IssueSimple', function() {
    it('should create an instance of IssueSimple', function() {
      // uncomment below and update the code to test IssueSimple
      //var instane = new GitHubV3RestApi.IssueSimple();
      //expect(instance).to.be.a(GitHubV3RestApi.IssueSimple);
    });
