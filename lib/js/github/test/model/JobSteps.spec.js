...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new GitHubV3RestApi.JobSteps();
  });
  ...
  describe('JobSteps', function() {
    it('should create an instance of JobSteps', function() {
      // uncomment below and update the code to test JobSteps
      //var instane = new GitHubV3RestApi.JobSteps();
      //expect(instance).to.be.a(GitHubV3RestApi.JobSteps);
    });
