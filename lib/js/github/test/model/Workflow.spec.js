...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new GitHubV3RestApi.Workflow();
  });
  ...
  describe('Workflow', function() {
    it('should create an instance of Workflow', function() {
      ...
      //var instane = new GitHubV3RestApi.Workflow();
      //expect(instance).to.be.a(GitHubV3RestApi.Workflow);
    });

    it('should have the property badgeUrl (base name: "badge_url")', function() {
