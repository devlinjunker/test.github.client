...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new GitHubV3RestApi.GitCommitParents();
  });
  ...
  describe('GitCommitParents', function() {
    it('should create an instance of GitCommitParents', function() {
      // uncomment below and update the code to test GitCommitParents
      //var instane = new GitHubV3RestApi.GitCommitParents();
      //expect(instance).to.be.a(GitHubV3RestApi.GitCommitParents);
    });
