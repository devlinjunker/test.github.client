...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new GitHubV3RestApi.EmailOneOf();
  });
  ...
  describe('EmailOneOf', function() {
    it('should create an instance of EmailOneOf', function() {
      // uncomment below and update the code to test EmailOneOf
      //var instane = new GitHubV3RestApi.EmailOneOf();
      //expect(instance).to.be.a(GitHubV3RestApi.EmailOneOf);
    });
