...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new GitHubV3RestApi.AuthenticationToken();
  });
  ...
  describe('AuthenticationToken', function() {
    it('should create an instance of AuthenticationToken', function() {
      ...
      //var instane = new GitHubV3RestApi.AuthenticationToken();
      //expect(instance).to.be.a(GitHubV3RestApi.AuthenticationToken);
    });
