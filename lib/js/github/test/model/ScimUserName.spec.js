...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new GitHubV3RestApi.ScimUserName();
  });
  ...
  describe('ScimUserName', function() {
    it('should create an instance of ScimUserName', function() {
      // uncomment below and update the code to test ScimUserName
      //var instane = new GitHubV3RestApi.ScimUserName();
      //expect(instance).to.be.a(GitHubV3RestApi.ScimUserName);
    });
