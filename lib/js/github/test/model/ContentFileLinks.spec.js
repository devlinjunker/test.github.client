...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new GitHubV3RestApi.ContentFileLinks();
  });
  ...
  describe('ContentFileLinks', function() {
    it('should create an instance of ContentFileLinks', function() {
      // uncomment below and update the code to test ContentFileLinks
      //var instane = new GitHubV3RestApi.ContentFileLinks();
      //expect(instance).to.be.a(GitHubV3RestApi.ContentFileLinks);
    });
