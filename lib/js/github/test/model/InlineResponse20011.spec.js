...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new GitHubV3RestApi.InlineResponse20011();
  });
  ...
  describe('InlineResponse20011', function() {
    it('should create an instance of InlineResponse20011', function() {
      ...
      //var instane = new GitHubV3RestApi.InlineResponse20011();
      //expect(instance).to.be.a(GitHubV3RestApi.InlineResponse20011);
    });

    it('should have the property checkRuns (base name: "check_runs")', function() {
      // uncomment below and update the code to test the property checkRuns
      //var instane = new GitHubV3RestApi.InlineResponse20011();
