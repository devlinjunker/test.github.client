...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new GitHubV3RestApi.OrgsOrgHooksConfig();
  });
  ...
  describe('OrgsOrgHooksConfig', function() {
    it('should create an instance of OrgsOrgHooksConfig', function() {
      // uncomment below and update the code to test OrgsOrgHooksConfig
      //var instane = new GitHubV3RestApi.OrgsOrgHooksConfig();
      //expect(instance).to.be.a(GitHubV3RestApi.OrgsOrgHooksConfig);
    });
