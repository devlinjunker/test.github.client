...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new GitHubV3RestApi.GistFullAllOfHistory();
  });
  ...
  describe('GistFullAllOfHistory', function() {
    it('should create an instance of GistFullAllOfHistory', function() {
      // uncomment below and update the code to test GistFullAllOfHistory
      //var instane = new GitHubV3RestApi.GistFullAllOfHistory();
      //expect(instance).to.be.a(GitHubV3RestApi.GistFullAllOfHistory);
    });
