...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new GitHubV3RestApi.StarredRepository();
  });
  ...
  describe('StarredRepository', function() {
    it('should create an instance of StarredRepository', function() {
      // uncomment below and update the code to test StarredRepository
      //var instane = new GitHubV3RestApi.StarredRepository();
      //expect(instance).to.be.a(GitHubV3RestApi.StarredRepository);
    });
