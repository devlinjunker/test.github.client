...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new GitHubV3RestApi.PullRequestHead();
  });
  ...
  describe('PullRequestHead', function() {
    it('should create an instance of PullRequestHead', function() {
      // uncomment below and update the code to test PullRequestHead
      //var instane = new GitHubV3RestApi.PullRequestHead();
      //expect(instance).to.be.a(GitHubV3RestApi.PullRequestHead);
    });
