...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new GitHubV3RestApi.GistFull();
  });
  ...
  describe('GistFull', function() {
    it('should create an instance of GistFull', function() {
      // uncomment below and update the code to test GistFull
      //var instane = new GitHubV3RestApi.GistFull();
      //expect(instance).to.be.a(GitHubV3RestApi.GistFull);
    });
