...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new GitHubV3RestApi.PrivateUserPlan();
  });
  ...
  describe('PrivateUserPlan', function() {
    it('should create an instance of PrivateUserPlan', function() {
      // uncomment below and update the code to test PrivateUserPlan
      //var instane = new GitHubV3RestApi.PrivateUserPlan();
      //expect(instance).to.be.a(GitHubV3RestApi.PrivateUserPlan);
    });
