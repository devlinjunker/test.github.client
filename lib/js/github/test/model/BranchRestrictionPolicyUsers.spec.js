...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new GitHubV3RestApi.BranchRestrictionPolicyUsers();
  });
  ...
  describe('BranchRestrictionPolicyUsers', function() {
    it('should create an instance of BranchRestrictionPolicyUsers', function() {
      // uncomment below and update the code to test BranchRestrictionPolicyUsers
      //var instane = new GitHubV3RestApi.BranchRestrictionPolicyUsers();
      //expect(instance).to.be.a(GitHubV3RestApi.BranchRestrictionPolicyUsers);
    });
