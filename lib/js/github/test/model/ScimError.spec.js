...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new GitHubV3RestApi.ScimError();
  });
  ...
  describe('ScimError', function() {
    it('should create an instance of ScimError', function() {
      // uncomment below and update the code to test ScimError
      //var instane = new GitHubV3RestApi.ScimError();
      //expect(instance).to.be.a(GitHubV3RestApi.ScimError);
    });
