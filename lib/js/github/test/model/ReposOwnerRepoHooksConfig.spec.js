...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new GitHubV3RestApi.ReposOwnerRepoHooksConfig();
  });
  ...
  describe('ReposOwnerRepoHooksConfig', function() {
    it('should create an instance of ReposOwnerRepoHooksConfig', function() {
      // uncomment below and update the code to test ReposOwnerRepoHooksConfig
      //var instane = new GitHubV3RestApi.ReposOwnerRepoHooksConfig();
      //expect(instance).to.be.a(GitHubV3RestApi.ReposOwnerRepoHooksConfig);
    });
