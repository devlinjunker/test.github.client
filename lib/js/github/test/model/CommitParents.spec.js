...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new GitHubV3RestApi.CommitParents();
  });
  ...
  describe('CommitParents', function() {
    it('should create an instance of CommitParents', function() {
      // uncomment below and update the code to test CommitParents
      //var instane = new GitHubV3RestApi.CommitParents();
      //expect(instance).to.be.a(GitHubV3RestApi.CommitParents);
    });
