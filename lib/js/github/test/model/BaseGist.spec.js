...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new GitHubV3RestApi.BaseGist();
  });
  ...
  describe('BaseGist', function() {
    it('should create an instance of BaseGist', function() {
      // uncomment below and update the code to test BaseGist
      //var instane = new GitHubV3RestApi.BaseGist();
      //expect(instance).to.be.a(GitHubV3RestApi.BaseGist);
    });
