...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new GitHubV3RestApi.BranchRestrictionPolicyPermissions();
  });
  ...
  describe('BranchRestrictionPolicyPermissions', function() {
    it('should create an instance of BranchRestrictionPolicyPermissions', function() {
      // uncomment below and update the code to test BranchRestrictionPolicyPermissions
      //var instane = new GitHubV3RestApi.BranchRestrictionPolicyPermissions();
      //expect(instance).to.be.a(GitHubV3RestApi.BranchRestrictionPolicyPermissions);
    });
