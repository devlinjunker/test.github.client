...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new GitHubV3RestApi.BranchRestrictionPolicyOwner();
  });
  ...
  describe('BranchRestrictionPolicyOwner', function() {
    it('should create an instance of BranchRestrictionPolicyOwner', function() {
      // uncomment below and update the code to test BranchRestrictionPolicyOwner
      //var instane = new GitHubV3RestApi.BranchRestrictionPolicyOwner();
      //expect(instance).to.be.a(GitHubV3RestApi.BranchRestrictionPolicyOwner);
    });
