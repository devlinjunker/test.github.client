...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new GitHubV3RestApi.OrganizationPlan();
  });
  ...
  describe('OrganizationPlan', function() {
    it('should create an instance of OrganizationPlan', function() {
      // uncomment below and update the code to test OrganizationPlan
      //var instane = new GitHubV3RestApi.OrganizationPlan();
      //expect(instance).to.be.a(GitHubV3RestApi.OrganizationPlan);
    });
