...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new GitHubV3RestApi.RepositoryTemplateRepository();
  });
  ...
  describe('RepositoryTemplateRepository', function() {
    it('should create an instance of RepositoryTemplateRepository', function() {
      // uncomment below and update the code to test RepositoryTemplateRepository
      //var instane = new GitHubV3RestApi.RepositoryTemplateRepository();
      //expect(instance).to.be.a(GitHubV3RestApi.RepositoryTemplateRepository);
    });
