...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new GitHubV3RestApi.GistFullAllOf();
  });
  ...
  describe('GistFullAllOf', function() {
    it('should create an instance of GistFullAllOf', function() {
      // uncomment below and update the code to test GistFullAllOf
      //var instane = new GitHubV3RestApi.GistFullAllOf();
      //expect(instance).to.be.a(GitHubV3RestApi.GistFullAllOf);
    });
