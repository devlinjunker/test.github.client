...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new GitHubV3RestApi.FileCommitCommitVerification();
  });
  ...
  describe('FileCommitCommitVerification', function() {
    it('should create an instance of FileCommitCommitVerification', function() {
      // uncomment below and update the code to test FileCommitCommitVerification
      //var instane = new GitHubV3RestApi.FileCommitCommitVerification();
      //expect(instance).to.be.a(GitHubV3RestApi.FileCommitCommitVerification);
    });
