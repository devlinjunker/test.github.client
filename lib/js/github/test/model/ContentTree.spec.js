...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new GitHubV3RestApi.ContentTree();
  });
  ...
  describe('ContentTree', function() {
    it('should create an instance of ContentTree', function() {
      // uncomment below and update the code to test ContentTree
      //var instane = new GitHubV3RestApi.ContentTree();
      //expect(instance).to.be.a(GitHubV3RestApi.ContentTree);
    });
