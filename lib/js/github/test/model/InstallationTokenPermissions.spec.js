...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new GitHubV3RestApi.InstallationTokenPermissions();
  });
  ...
  describe('InstallationTokenPermissions', function() {
    it('should create an instance of InstallationTokenPermissions', function() {
      // uncomment below and update the code to test InstallationTokenPermissions
      //var instane = new GitHubV3RestApi.InstallationTokenPermissions();
      //expect(instance).to.be.a(GitHubV3RestApi.InstallationTokenPermissions);
    });
