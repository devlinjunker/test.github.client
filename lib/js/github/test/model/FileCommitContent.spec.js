...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new GitHubV3RestApi.FileCommitContent();
  });
  ...
  describe('FileCommitContent', function() {
    it('should create an instance of FileCommitContent', function() {
      // uncomment below and update the code to test FileCommitContent
      //var instane = new GitHubV3RestApi.FileCommitContent();
      //expect(instance).to.be.a(GitHubV3RestApi.FileCommitContent);
    });
