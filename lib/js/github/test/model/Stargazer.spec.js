...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new GitHubV3RestApi.Stargazer();
  });
  ...
  describe('Stargazer', function() {
    it('should create an instance of Stargazer', function() {
      // uncomment below and update the code to test Stargazer
      //var instane = new GitHubV3RestApi.Stargazer();
      //expect(instance).to.be.a(GitHubV3RestApi.Stargazer);
    });
