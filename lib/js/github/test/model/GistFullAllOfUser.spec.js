...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new GitHubV3RestApi.GistFullAllOfUser();
  });
  ...
  describe('GistFullAllOfUser', function() {
    it('should create an instance of GistFullAllOfUser', function() {
      // uncomment below and update the code to test GistFullAllOfUser
      //var instane = new GitHubV3RestApi.GistFullAllOfUser();
      //expect(instance).to.be.a(GitHubV3RestApi.GistFullAllOfUser);
    });
