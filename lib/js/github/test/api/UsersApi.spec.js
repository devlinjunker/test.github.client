...
(function(root, factory) {
  ...
  describe('UsersApi', function() {
    ...
    describe('usersBlock', function() {
      it('should call usersBlock successfully', function(done) {
        //uncomment below and update the code to test usersBlock
        //instance.usersBlock(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
    ...
    describe('usersCheckBlocked', function() {
      it('should call usersCheckBlocked successfully', function(done) {
        //uncomment below and update the code to test usersCheckBlocked
        //instance.usersCheckBlocked(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
    ...
    describe('usersListBlockedByAuthenticated', function() {
      it('should call usersListBlockedByAuthenticated successfully', function(done) {
        //uncomment below and update the code to test usersListBlockedByAuthenticated
        //instance.usersListBlockedByAuthenticated(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
    ...
    describe('usersSetPrimaryEmailVisibilityForAuthenticated', function() {
      it('should call usersSetPrimaryEmailVisibilityForAuthenticated successfully', function(done) {
        //uncomment below and update the code to test usersSetPrimaryEmailVisibilityForAuthenticated
        //instance.usersSetPrimaryEmailVisibilityForAuthenticated(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
    ...
    describe('usersUnblock', function() {
      it('should call usersUnblock successfully', function(done) {
        //uncomment below and update the code to test usersUnblock
        //instance.usersUnblock(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
