    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('organization')) {
                obj['organization'] = ApiClient.convertToType(data['organization'], SimpleUser);
            }
            ...
            if (data.hasOwnProperty('template_repository')) {
                obj['template_repository'] = ApiClient.convertToType(data['template_repository'], Repository);
            }
