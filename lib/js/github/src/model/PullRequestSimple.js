...
import PullRequestSimpleLabels from './PullRequestSimpleLabels';
...
class PullRequestSimple {
     ...
     */
    constructor(links, assignee, authorAssociation, base, body, closedAt, commentsUrl, commitsUrl, createdAt, diffUrl, head, htmlUrl, id, issueUrl, labels, locked, mergeCommitSha, mergedAt, milestone, nodeId, _number, patchUrl, reviewCommentUrl, reviewCommentsUrl, state, statusesUrl, title, updatedAt, url, user) { 
    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('labels')) {
                obj['labels'] = ApiClient.convertToType(data['labels'], [PullRequestSimpleLabels]);
            }
