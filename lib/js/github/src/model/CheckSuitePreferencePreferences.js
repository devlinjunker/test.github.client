...
import CheckSuitePreferencePreferencesAutoTriggerChecks from './CheckSuitePreferencePreferencesAutoTriggerChecks';
    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('auto_trigger_checks')) {
                obj['auto_trigger_checks'] = ApiClient.convertToType(data['auto_trigger_checks'], [CheckSuitePreferencePreferencesAutoTriggerChecks]);
            }
        }
        return obj;
    }
