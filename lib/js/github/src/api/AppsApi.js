...
export default class AppsApi {
    ...
    */
     ...
     * data is of type: {@link module:model/Authorization}
     */
    appsCheckToken(clientId, opts, callback) {
      opts = opts || {};
     ...
     */
    appsCreateContentAttachment(contentReferenceId, opts, callback) {
      opts = opts || {};
     ...
     */
    appsDeleteToken(clientId, opts, callback) {
      opts = opts || {};
     ...
     * data is of type: {@link module:model/Authorization}
     */
    appsResetToken(clientId, opts, callback) {
      opts = opts || {};
