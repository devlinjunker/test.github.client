...
export default class GitApi {
    ...
    */
     ...
     */
    gitCreateBlob(owner, repo, opts, callback) {
      opts = opts || {};
     ...
     */
    gitCreateCommit(owner, repo, opts, callback) {
      opts = opts || {};
     ...
     */
    gitCreateRef(owner, repo, opts, callback) {
      opts = opts || {};
     ...
     */
    gitCreateTag(owner, repo, opts, callback) {
      opts = opts || {};
     ...
     */
    gitCreateTree(owner, repo, opts, callback) {
      opts = opts || {};
      let postBody = opts['inlineObject71'];
      // verify the required parameter 'owner' is set
      if (owner === undefined || owner === null) {
     ...
     * data is of type: {@link module:model/GitRef}
     */
    gitUpdateRef(owner, repo, ref, opts, callback) {
      opts = opts || {};
