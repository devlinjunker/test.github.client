...
export default class ActionsApi {
    ...
    */
     ...
     */
    actionsCreateOrUpdateOrgSecret(org, secretName, opts, callback) {
      opts = opts || {};
     ...
     */
    actionsCreateOrUpdateRepoSecret(owner, repo, secretName, opts, callback) {
      opts = opts || {};
     ...
     */
    actionsCreateWorkflowDispatch(owner, repo, workflowId, opts, callback) {
      opts = opts || {};
      let postBody = opts['inlineObject48'];
      // verify the required parameter 'owner' is set
      if (owner === undefined || owner === null) {
     ...
     */
    actionsGetWorkflowRun(owner, repo, runId, callback) {
      let postBody = null;
      // verify the required parameter 'owner' is set
      if (owner === undefined || owner === null) {
     ...
     */
    actionsListSelectedReposForOrgSecret(org, secretName, callback) {
      let postBody = null;
      // verify the required parameter 'org' is set
      if (org === undefined || org === null) {
     ...
     */
    actionsSetSelectedReposForOrgSecret(org, secretName, opts, callback) {
      opts = opts || {};
