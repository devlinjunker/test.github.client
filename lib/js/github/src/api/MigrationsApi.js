...
export default class MigrationsApi {
    ...
    */
     ...
     * data is of type: {@link module:model/Migration}
     */
    migrationsGetStatusForOrg(org, migrationId, callback) {
      let postBody = null;
      // verify the required parameter 'org' is set
      if (org === undefined || org === null) {
     ...
     * data is of type: {@link Array.<module:model/MinimalRepository>}
     */
    migrationsListReposForUser(migrationId, opts, callback) {
      opts = opts || {};
      let postBody = null;
      // verify the required parameter 'migrationId' is set
      if (migrationId === undefined || migrationId === null) {
     ...
     * data is of type: {@link module:model/ModelImport}
     */
    migrationsSetLfsPreference(owner, repo, opts, callback) {
      opts = opts || {};
     ...
     * data is of type: {@link module:model/Migration}
     */
    migrationsStartForAuthenticatedUser(opts, callback) {
      opts = opts || {};
     ...
     * data is of type: {@link module:model/Migration}
     */
    migrationsStartForOrg(org, opts, callback) {
      opts = opts || {};
     ...
     * data is of type: {@link module:model/ModelImport}
     */
    migrationsStartImport(owner, repo, opts, callback) {
      opts = opts || {};
