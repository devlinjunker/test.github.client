...
// tests for InlineObject63
void main() {
    var instance = new InlineObject63();

  group('test InlineObject63', () {
    ...
    // bool autoInactive (default value: null)
    ...
    // String environment (default value: null)
