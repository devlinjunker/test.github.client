...
// tests for InlineObject56
void main() {
    var instance = new InlineObject56();

  group('test InlineObject56', () {
    ...
    // String permission (default value: "push")
    test('to test the property `permission`', () async {
      // TODO
    });

    // String permissions (default value: null)
