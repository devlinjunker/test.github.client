...
// tests for FileCommitCommit
void main() {
    var instance = new FileCommitCommit();

  group('test FileCommitCommit', () {
    // FileCommitCommitAuthor author (default value: null)
    test('to test the property `author`', () async {
      // TODO
    });

    // FileCommitCommitAuthor committer (default value: null)
    ...
    // List<CommitSearchResultItemParents> parents (default value: [])
    ...
    // BranchShortCommit tree (default value: null)
    ...
    // FileCommitCommitVerification verification (default value: null)
