...
// tests for LicenseContent
void main() {
    var instance = new LicenseContent();

  group('test LicenseContent', () {
    // ContentFileLinks links (default value: null)
    ...
    // String downloadUrl (default value: null)
    test('to test the property `downloadUrl`', () async {
      // TODO
    });

    // String encoding (default value: null)
