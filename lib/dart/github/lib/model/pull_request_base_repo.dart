...
class PullRequestBaseRepo {
  ...
  PullRequestBaseRepoOwner owner = null;
  ...
  PullRequestBaseRepo.fromJson(Map<String, dynamic> json) {
    ...
    owner = (json['owner'] == null) ?
      null :
      PullRequestBaseRepoOwner.fromJson(json['owner']);
  ...
  static List<PullRequestBaseRepo> listFromJson(List<dynamic> json) {
    return json == null ? List<PullRequestBaseRepo>() : json.map((value) => PullRequestBaseRepo.fromJson(value)).toList();
  }

  static Map<String, PullRequestBaseRepo> mapFromJson(Map<String, dynamic> json) {
    var map = Map<String, PullRequestBaseRepo>();
    if (json != null && json.isNotEmpty) {
      json.forEach((String key, dynamic value) => map[key] = PullRequestBaseRepo.fromJson(value));
    }
    return map;
  }

  // maps a json object with a list of PullRequestBaseRepo-objects as value to a dart map
  static Map<String, List<PullRequestBaseRepo>> mapListFromJson(Map<String, dynamic> json) {
    var map = Map<String, List<PullRequestBaseRepo>>();
     if (json != null && json.isNotEmpty) {
       json.forEach((String key, dynamic value) {
         map[key] = PullRequestBaseRepo.listFromJson(value);
       });
     }
     return map;
  }
