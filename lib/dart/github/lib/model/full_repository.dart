...
class FullRepository {
  ...
  FullRepository.fromJson(Map<String, dynamic> json) {
    ...
    organization = (json['organization'] == null) ?
      null :
      SimpleUser.fromJson(json['organization']);
    ...
    source_ = (json['source'] == null) ?
      null :
      Repository.fromJson(json['source']);
    sshUrl = json['ssh_url'];
    ...
    templateRepository = (json['template_repository'] == null) ?
      null :
      Repository.fromJson(json['template_repository']);
  ...
  Map<String, dynamic> toJson() {
    ...
    if (anonymousAccessEnabled != null)
      json['anonymous_access_enabled'] = anonymousAccessEnabled;
    if (archiveUrl != null)
  ...
  static List<FullRepository> listFromJson(List<dynamic> json) {
    return json == null ? List<FullRepository>() : json.map((value) => FullRepository.fromJson(value)).toList();
  }

  static Map<String, FullRepository> mapFromJson(Map<String, dynamic> json) {
    var map = Map<String, FullRepository>();
    if (json != null && json.isNotEmpty) {
      json.forEach((String key, dynamic value) => map[key] = FullRepository.fromJson(value));
    }
    return map;
  }

  // maps a json object with a list of FullRepository-objects as value to a dart map
  static Map<String, List<FullRepository>> mapListFromJson(Map<String, dynamic> json) {
    var map = Map<String, List<FullRepository>>();
     if (json != null && json.isNotEmpty) {
       json.forEach((String key, dynamic value) {
         map[key] = FullRepository.listFromJson(value);
       });
     }
     return map;
  }
