...
class RepositoryTemplateRepository {
  ...
  BranchRestrictionPolicyUsers owner = null;
  
  MinimalRepositoryPermissions permissions = null;
  ...
  RepositoryTemplateRepository.fromJson(Map<String, dynamic> json) {
    ...
    owner = (json['owner'] == null) ?
      null :
      BranchRestrictionPolicyUsers.fromJson(json['owner']);
    permissions = (json['permissions'] == null) ?
      null :
      MinimalRepositoryPermissions.fromJson(json['permissions']);
  ...
  static List<RepositoryTemplateRepository> listFromJson(List<dynamic> json) {
    return json == null ? List<RepositoryTemplateRepository>() : json.map((value) => RepositoryTemplateRepository.fromJson(value)).toList();
  }

  static Map<String, RepositoryTemplateRepository> mapFromJson(Map<String, dynamic> json) {
    var map = Map<String, RepositoryTemplateRepository>();
    if (json != null && json.isNotEmpty) {
      json.forEach((String key, dynamic value) => map[key] = RepositoryTemplateRepository.fromJson(value));
    }
    return map;
  }

  // maps a json object with a list of RepositoryTemplateRepository-objects as value to a dart map
  static Map<String, List<RepositoryTemplateRepository>> mapListFromJson(Map<String, dynamic> json) {
    var map = Map<String, List<RepositoryTemplateRepository>>();
     if (json != null && json.isNotEmpty) {
       json.forEach((String key, dynamic value) {
         map[key] = RepositoryTemplateRepository.listFromJson(value);
       });
     }
     return map;
  }
