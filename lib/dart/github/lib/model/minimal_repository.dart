...
class MinimalRepository {
  ...
  MinimalRepositoryLicense license = null;
  ...
  MinimalRepository.fromJson(Map<String, dynamic> json) {
    ...
    license = (json['license'] == null) ?
      null :
      MinimalRepositoryLicense.fromJson(json['license']);
  ...
  static List<MinimalRepository> listFromJson(List<dynamic> json) {
    return json == null ? List<MinimalRepository>() : json.map((value) => MinimalRepository.fromJson(value)).toList();
  }

  static Map<String, MinimalRepository> mapFromJson(Map<String, dynamic> json) {
    var map = Map<String, MinimalRepository>();
    if (json != null && json.isNotEmpty) {
      json.forEach((String key, dynamic value) => map[key] = MinimalRepository.fromJson(value));
    }
    return map;
  }

  // maps a json object with a list of MinimalRepository-objects as value to a dart map
  static Map<String, List<MinimalRepository>> mapListFromJson(Map<String, dynamic> json) {
    var map = Map<String, List<MinimalRepository>>();
     if (json != null && json.isNotEmpty) {
       json.forEach((String key, dynamic value) {
         map[key] = MinimalRepository.listFromJson(value);
       });
     }
     return map;
  }
