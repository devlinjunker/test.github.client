...
class PullRequestHeadRepo {
  ...
  PullRequestHeadRepo.fromJson(Map<String, dynamic> json) {
    ...
    license = (json['license'] == null) ?
      null :
      PullRequestHeadRepoLicense.fromJson(json['license']);
  ...
  static List<PullRequestHeadRepo> listFromJson(List<dynamic> json) {
    return json == null ? List<PullRequestHeadRepo>() : json.map((value) => PullRequestHeadRepo.fromJson(value)).toList();
  }

  static Map<String, PullRequestHeadRepo> mapFromJson(Map<String, dynamic> json) {
    var map = Map<String, PullRequestHeadRepo>();
    if (json != null && json.isNotEmpty) {
      json.forEach((String key, dynamic value) => map[key] = PullRequestHeadRepo.fromJson(value));
    }
    return map;
  }

  // maps a json object with a list of PullRequestHeadRepo-objects as value to a dart map
  static Map<String, List<PullRequestHeadRepo>> mapListFromJson(Map<String, dynamic> json) {
    var map = Map<String, List<PullRequestHeadRepo>>();
     if (json != null && json.isNotEmpty) {
       json.forEach((String key, dynamic value) {
         map[key] = PullRequestHeadRepo.listFromJson(value);
       });
     }
     return map;
  }
